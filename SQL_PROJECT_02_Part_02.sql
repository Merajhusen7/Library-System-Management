...
SELECT 
   ...
   ist.issued_date,
   rs.return_date,
    return_date - issued_date AS overdue_days
...
BEGIN
   --all yout logic and codes are here
...
-- all the logics/codes
   --checking if the book is available 'yes'
	...
	ELSE
	  RAISE NOTICE 'Sorry to inform you that the book you requested in not avaialbale now book_isbn : %', p_issued_book_isbn;
